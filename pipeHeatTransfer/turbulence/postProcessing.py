...
def TPlus(T, u, r, rho, Cp, qw):
    pass


def  TPlusTheory(yPlusPr):
    if yPlusPr < 1:
        return yPlusPr
    elif yPlusPr >= 1 and yPlusPr < 11.7:
        return 1.87 * np.log(yPlusPr + 1) + 0.065 * yPlusPr - 0.36
    else:
        return 2.5 * np.log(yPlusPr) - 1
...
print(ReToU(200000, D=0.01, nu=1.5e-7))
...
plt.plot(r_line/R, theta_2(T_line, U_line, r_line, X=X, w=W), 'o')
# plt.plot(r_line/R, T_line, 'o')
