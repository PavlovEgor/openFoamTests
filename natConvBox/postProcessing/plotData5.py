...
dataGPU_PETSC_5060 = np.loadtxt('dataGPU_SPUMA_PETSC_5060.txt')
dataGPU_PETSC_T4 = np.loadtxt('PETSC_CPU_vs_GPU/Intel_vs_T4/dataGPU_PETSC_HYPER_SPUMA_auto_periodic_10000.txt')
...
plot(ax1, dataGPU_PETSC_5060, color=colors[0], marker='o', linestyle='--', label=r'GPU PETSC 5060Ti')
plot(ax1, dataGPU_PETSC_T4, color=colors[1], marker='o', linestyle='--', label=r'GPU PETSC T4')
